      ...
      <div className="border-t border-sidebar-border p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-sidebar-foreground/60 truncate">student@example.com</p>
          </div>
        ...
        <header className="flex h-16 items-center justify-between border-b border-border bg-card/50 px-4 lg:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="hidden text-sm font-medium md:inline-block">Nguyễn Văn A</span>
            </div>
          </div>
        </header>
