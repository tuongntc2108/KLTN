      ...
      <div className="border-t border-sidebar-border p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-sidebar-foreground">Trung tâm ABC</p>
            <p className="text-xs text-sidebar-foreground/60 truncate">admin@abc.edu.vn</p>
          </div>
        ...
        <header className="flex h-16 items-center justify-between border-b border-border bg-card/50 px-4 lg:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="hidden text-sm font-medium md:inline-block">Trung tâm ABC</span>
            </div>
          </div>
        </header>
