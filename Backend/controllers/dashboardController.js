    ...
    try {
      ...
      try {
        ...
        const certificatesQuery = `
          ...
          FROM certificates
        `
        const certificatesResult = await client.query(certificatesQuery)
        ...
        const activeCertificatesQuery = `
          ...
          FROM certificates
        `
        const activeCertificatesResult = await client.query(activeCertificatesQuery)
        ...
        const stats = {
          ...
          totalCertificatesIssued: parseInt(certificatesData.total_certificates) || 0,
